...
function CodePannel() {
    ...
    return (
        <div className="fixed mx-auto inset-x-0 z-10 bottom-24 max-w-xl h-fit w-full rounded-2xl p-2 transition-[height] duration-300 bg-gray-50 ring-1 ring-gray-200 dark:ring-gray-900 border border-white shadow-md shadow-gray-950/5 dark:shadow-gray-950/50 dark:bg-gray-950/50 backdrop-blur-2xl dark:border-white/10">
