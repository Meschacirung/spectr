        ...
        <AppIcon mouseX={mouseX} tooltip="Tailus UI" href="/#tailus-ui">
          ...
          <svg className="size-full relative text-gray-950 dark:text-white transition group-active:scale-90" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            ...
            >
                {
                    darkMode ? 
                      <svg className="size-full relative text-gray-950 dark:text-white transition group-active:scale-90" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 256 256">
                          <g fill="currentColor">
                    ...
                    :   <svg aria-hidden="true" className="size-full p-0.5 text-gray-950 relative transition group-active:scale-90" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
