...
import { setIsOpen } from "@store/code-pannel"
...
export function OptionsDock() {
  ...
  return (
    <motion.div
      ...
      className="mx-auto flex h-[3.6rem] w-fit gap-1.5 ring-1 ring-gray-200 dark:ring-gray-900 items-end pb-1.5 px-1.5 border border-white/10 rounded-2xl shadow-md shadow-gray-950/5 bg-white/10 dark:bg-gray-900/25 backdrop-blur-2xl dark:border-white/10"
      >
          <AppIcon mouseX={mouseX} tooltip="Home" href="#home">
              <svg className="relative size-full duration-300 text-gray-950 dark:text-white transition group-active:scale-90" width="32" height="32" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <AppIcon mouseX={mouseX} tooltip="Tailus UI" href="/#tailus-ui">
            <svg className="relative size-full text-gray-950 dark:text-white transition group-active:scale-90" width="32" height="32" viewBox="0 0 84 84" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <AppIcon mouseX={mouseX} tooltip="Nuxt UI" href="/#nuxt-ui">
              <svg className="relative size-full text-gray-950 dark:text-white transition group-active:scale-90" width="32" height="32" viewBox="0 0 264 264" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <AppIcon mouseX={mouseX} tooltip="Shadcn" href="/#shadcn-ui">
            <svg className="size-full relative text-gray-950 dark:text-white transition group-active:scale-90" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256">
          ...
          <span className="h-6 w-px bg-gray-950/10 dark:bg-white/10 mx-2 -translate-y-2"></span>
          <AppIcon onClick={setIsOpen} mouseX={mouseX} tooltip="Code">
          <svg className="size-full relative text-gray-950 dark:text-white transition group-active:scale-90" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
        ...
        className="relative"
            >
                    <svg className="size-full absolute inset-0 m-auto p-2 scale-[2] opacity-0 dark:scale-100 dark:opacity-100 -rotate-180 dark:rotate-0 text-white transition duration-500 group-active:scale-90" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 256 256">
                        <g fill="currentColor">
                    ...
                    <svg aria-hidden="true" className="size-full p-0.5 scale-100 dark:scale-0 dark:rotate-90 text-gray-950 relative transition duration-500 dark:opacity-0 group-active:scale-90" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
