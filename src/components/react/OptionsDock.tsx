...
export function OptionsDock() {
  ...
  return (
    <motion.div
      ...
      className="mx-auto flex h-[3.6rem] w-fit gap-1.5 ring-1 ring-white/50 dark:ring-gray-950/50 items-end pb-1.5 px-1.5 border border-gray-950/10 rounded-2xl shadow-sm shadow-gray-950/5 bg-white/75 dark:bg-gray-950/50 backdrop-blur-2xl dark:border-white/10"
      >
          <AppIcon mouseX={mouseX} tooltip="Home">
              <svg className="relative size-5 text-gray-950 dark:text-white" width="32" height="32" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
<circle cx="40" cy="31" r="5" fill="currentColor"/>
<circle cx="59" cy="31" r="5" fill="currentColor"/>
<circle cx="40" cy="50" r="5" fill="currentColor"/>
<circle cx="59" cy="50" r="5" fill="currentColor"/>
<circle cx="40" cy="69" r="5" fill="currentColor"/>
<circle cx="59" cy="69" r="5" fill="currentColor"/>
</svg>

          </AppIcon>
          <span className="h-6 w-px  bg-gray-950/10 dark:bg-white/10 mx-2 -translate-y-2"></span>
        <AppIcon mouseX={mouseX} tooltip="Tailus UI">
            <svg className="relative size-5 text-gray-950 dark:text-white" width="32" height="32" viewBox="0 0 84 84" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <AppIcon mouseX={mouseX} tooltip="Nuxt UI">
              <svg className="relative size-5 text-gray-950 dark:text-white" width="264" height="264" viewBox="0 0 264 264" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <AppIcon mouseX={mouseX} tooltip="Shadcn">
            <svg className="size-5 relative text-gray-950 dark:text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256">
          ...
          <AppIcon mouseX={mouseX} tooltip="Code">
            ...
            >
                {
                    darkMode ? 
                      <svg className="size-5 relative text-gray-950 dark:text-white" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 256 256">
                          <g fill="currentColor">
                    ...
                    :   <svg aria-hidden="true" className="size-4 text-gray-950 relative" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
...
const AppIcon:React.FC<AppIconProps> = ({ mouseX, tooltip, children, ...props }) => {
  ...
  let widthSync = useTransform(distance, [-150, 0, 150], [43, 75, 43]);
        ...
        <Tooltip.Root delayDuration={50}>
            <Tooltip.Trigger asChild>
                <motion.button
                    ...
                    style={{ width }}
                    {...props}
                    className={`aspect-square group w-10 overflow-hidden bg-white flex items-center rounded-lg shadow shadow-gray-950/5 dark:shadow-inner dark:shadow-white/0 justify-center group relative before:absolute before:inset-0 before:rounded-[7px] before:border-t before:border-t-white dark:before:border-t-white/10 before:bg-gradient-to-b before:from-gray-50 dark:before:from-white/0 dark:ring ring-gray-50 border dark:ring-gray-950/25 dark:bg-gray-900 dark:border-gray-900 hover:before:from-gray-100 dark:hover:before:from-white/5`}
                >
                    {children}
                </motion.button>  
            </Tooltip.Trigger>
