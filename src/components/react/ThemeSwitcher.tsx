...
const ThemeSwitcher = () => {
  ...
  return (
    ...
    >
        {
            darkMode ? 
                <svg aria-hidden="true" className="relative size-4 text-white" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
