...
/**
 * Renders the root component for tabs with optional variant and intent.
 *
 * @component
 * @example
 * // Usage
 * <TabsRoot variant="default" intent="primary" />
 *
 * @param {object} props - The component props.
 * @param {string} props.variant - The variant of the tabs. Can be "default", "soft", or "outlined".
 * @param {string} props.intent - The intent of the tabs. Can be "primary", "secondary", or "none".
 * @param {React.Ref} forwardedRef - The forwarded ref for the component.
